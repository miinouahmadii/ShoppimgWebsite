...
void get_offers_command();
void get_offers();
void show_offer_descend();
void show_offer_ascend();
void open_file_csv_test();
void check_string(string str);
void open_file_csv_train() ;
long double find_bad_rate(string word);
long double find_good_rate(string word);
void print_zero_one();
void print_percent();
void open_file_class_probablities();
void post_evaluateModel_command();
...
private:
    ...
    unordered_map<string, long double> good; 
    unordered_map<string, long double> bad; 
